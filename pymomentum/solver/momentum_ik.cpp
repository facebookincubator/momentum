...
struct IKProblemAutogradFunction
 ...
 public:
  static variable_list forward(
      ...
      at::Tensor projectionCons_cameras,
      ...
      at::Tensor distanceCons_cameras,
...
variable_list IKProblemAutogradFunction<T, IKFunction>::backward(
  ...
  auto projectionCons_cameras = checkAndIncrementSavedItr();
  ...
  auto distanceCons_cameras = checkAndIncrementSavedItr();
...
torch::Tensor solveBodyIKProblem(
  ...
  return applyIKProblemAutogradFunction<IKSolveFunction>(
      ...
      denullify(projectionCons_cameras),
      ...
      denullify(distanceCons_cameras),
